...
public class ProductTest {
    public static void main(String[] args) {
        ...
        System.out.println("Created At (read-only): " + laptop.getCreatetAt());
        ...
        laptop.changePin("1234", "5678");
        laptop.changePin("0000", "9999"); // Akan gagal
        ...
        laptop.setStok(10, "5678"); // PIN sudah diubah
